...
export const getCountryByDialCode = (dialCode: string): CountryType | undefined => {
	return getCountries().find((country) => country.dialCode === dialCode);
};

export const getCountryByName = (name: string): CountryType | undefined => {
	return getCountries().find((country) => country.name.toLowerCase() === name.toLowerCase());
};
